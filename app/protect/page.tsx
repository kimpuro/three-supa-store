  ...
  return (
    <main className="grid min-h-full place-items-center bg-white px-6 py-24 sm:py-32 lg:px-8">
      <div className="text-center">
        <p className="text-base font-semibold text-cyan-500">Protect</p>
        <h1 className="mt-4 text-3xl font-bold tracking-tight text-gray-900 sm:text-5xl">마이 페이지 입니다.</h1>
        <p className="mt-6 text-base leading-7 text-gray-600">
          당신의 이메일은 {data.user.email}</p>
