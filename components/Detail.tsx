...
const product = {
  name: '정말 멋진 신발',
  price: '$100',
  description: '이 신발은 정말 멋지고 편하며 마음대로 커스텀도 가능합니다.',
  highlights: ['커스텀이 가능한 색상', '편안한 착용감', '멋진 디자인'],
          ...
          <div className="mx-auto mt-14 max-w-2xl sm:mt-16 lg:col-span-3 lg:row-span-2 lg:row-end-2 lg:mt-0 lg:max-w-none">
            <div className="flex flex-col-reverse">
              <div className="mt-4">
                ...
                <p className="mt-2 text-sm text-gray-500">왜 멋질까?</p>
              </div>
